package com.svs.krishi.grainservice.app.model.grain;

import com.google.gson.Gson;
import com.svs.krishi.grainservice.app.model.grain.translation.InstanceTranslation;
...
public class GrainDimensions {
    ...
    public String toCSVString() {
        final StringBuilder sb = new StringBuilder(grainType).append(COMMA_DELIMIT).append(particleType);
        DIMENSIONS_METADATA.stream()
